...
class DogCardAdapter(
    ...
    class DogCardViewHolder(view: View?) : RecyclerView.ViewHolder(view!!) {
        ...
        val nameText: TextView? = view!!.findViewById(R.id.dog_name)
        val ageText: TextView? = view!!.findViewById(R.id.dog_age)
        val hobbiesText: TextView? = view!!.findViewById(R.id.dog_hobbies)
    }
    ...
    override fun onBindViewHolder(holder: DogCardViewHolder, position: Int) {
        ...
        holder.hobbiesText?.text = resources?.getString(R.string.dog_hobbies, item.hobbies)
